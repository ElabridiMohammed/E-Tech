...
(function($) {
    ...
    * ------------------------------------------------------ */
    var clCountDown = function() {
        ...
        var countdown = function() {
            ...
            // Display the result
            document.querySelector('.counter .days').innerHTML = 
                (days < 10 ? "0" + days : days) + "<span>   D</span>";
            document.querySelector('.counter .hours').innerHTML = 
            ...
            document.querySelector('.counter .seconds').innerHTML = 
                (seconds < 10 ? "0" + seconds : seconds) + "<span> S</span>";
            
            // If the countdown is finished, display a message
            if (distance < 0) {
                clearInterval(countdownInterval);
                document.querySelector('.counter').innerHTML = "EVENT HAS STARTED!";
            }
        };
    ...
    * ------------------------------------------------------ */
    (function ssInit() {
        ...
        ssBackToTop();
        ssAjaxChimp();
        clCountDown(); // Initialize the countdown timer
